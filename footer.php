<div class="container-fluid py-4 mt-4 content-subscribe text-light">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-1 d-flex justify-content-center">
                <a href="http://whatsapp.com"><i class="fab fa-whatsapp fs-4"></i></a>
            </div>
        </div>
    </div>
</div>
