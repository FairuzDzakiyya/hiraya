...
<div class="container mt-5">
  ...
  <div class="my-5 col-12 col-md-6">
        ...
        ?>
            ...
            <meta http-equiv="refresh" content="2; url=pw.php" />
            <?php
        }
        else{
    ...
    <div class="table-responsive mt-5">
        <table class="table">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td colspan="3" class="text-center">Data Pakaian Wanita tidak tersedia</td>
                    </tr>
                <?php
                    }
                    else {
